...
public class IflytekUtils extends BaseApp {
    /**
     * modify by wuxf1900906 ,切换最新调用方式和调用  appId
     */
    public IflytekUtils() {
        this.apiClient = new ApiClient();
        this.apiClient.init();
        this.appId = "883f205442b14fdfa394355d3a1df7bb";
        this.appSecret = "9247B57C4F90E1979A99918B601FDC1F";
        ...
        this.publicKey = "305C300D06092A864886F70D0101010500034B003048024100BA465AB33209C569668C19FFD86C866322E80DCDEBB8905F025BC6EE25AAE227CCBAD8E9F649379F0E9291EF0E614568E201324418EA58415C1E5D900191F4E50203010001";
		//关闭云锁验证
...
/*	        this.appId = "7350c3589b104835a17983c83bc0aee3";
    ...
    public JSONObject querySummaryResp(JSONObject jsonReq) throws Exception {
        ...
        //请求成功，返回请求结果
        if ("200".equals(respJson.getString("flag"))) {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String jsonStr = "{\"contentCode\":\"11340825003129846T0001\",\"code\":\"1.2.156.3003.2.11340000725549332A0201.202012011144523498.00.4\",\"validBegin\":\"2016-08-30\",\"infoTypeCode\":\"099\",\"signCount\":\"0\",\"infoCode\":\"3400104925413377\",\"operateType\":\"U\",\"ownerId\":\"91340811733031998B13377\",\"version\":\"V2.00\",\"contentName\":\"不动产登记证明-个人\",\"makeTime\":\"2020-12-01\",\"areaCode\":\"340800\",\"ownerName\":\"上海浦东发展银行股份有限公司太湖分行7\",\"systemCode\":\"aqzzk\",\"createTime\":\"2020-12-02\",\"validEnd\":\"2999-12-31\",\"bizId\":\"16c0503f15014335ae3e83b357916d49\",\"contentMd5\":\"1\",\"dataSource\":\"2\"}";
        ApiResponse apu = iflytekUtils.key_WEIHU(jsonStr.getBytes("UTF-8"));
        String result = new String(apu.getBody(), "UTF-8");
        System.out.println("索引上报返回结果:" + result);
    }
