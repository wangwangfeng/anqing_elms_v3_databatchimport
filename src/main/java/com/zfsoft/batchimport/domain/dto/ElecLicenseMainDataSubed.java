 ...
 * @author chenjian
 */
public class ElecLicenseMainDataSubed implements Serializable {
     ...
     * 自动年检提前具体时间
     */
    private Date advanceAnnualDate;
    /**
     * 证照等级  A,B,C,D
     */
    ...
    /**
     * 维护中标记 null|0  未参加维护 , 1 注销中 2 吊销中  3 延续中 4 纠错中 5 变更中 6年检审核
     */
    private String underMaintenanceFlag;
    ...
    private ElecLicenseDirTypeTime elecLicenseDirTypeTime;
    ...
    public String getUnderMaintenanceFlag() {
        return underMaintenanceFlag;
    }

    public void setUnderMaintenanceFlag(String underMaintenanceFlag) {
        this.underMaintenanceFlag = underMaintenanceFlag;
    }
    ...
    public ElecLicenseDirTypeTime getElecLicenseDirTypeTime() {
        return elecLicenseDirTypeTime;
    }

    public void setElecLicenseDirTypeTime(ElecLicenseDirTypeTime elecLicenseDirTypeTime) {
        this.elecLicenseDirTypeTime = elecLicenseDirTypeTime;
    }

    public String getTableParamJson() {
        return tableParamJson;
    }

    public void setTableParamJson(String tableParamJson) {
        this.tableParamJson = tableParamJson;
    }
    ...
    public Date getAdvanceAnnualDate() {
        return advanceAnnualDate;
    }

    public void setAdvanceAnnualDate(Date advanceAnnualDate) {
        this.advanceAnnualDate = advanceAnnualDate;
    }
